...
// @access  Private (Supplier)
router.put('/transport-rates', auth, authorize('supplier'), checkSupplierSuspension, [  body('upTo5km.costPerKm').isFloat({ min: 0 }).withMessage('Cost per km must be positive'),
